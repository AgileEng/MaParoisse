...
folder are mapped to the application's root namespace, 'MaParoisse'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "MaParoisse"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'MaParoisse' in the same way
as `"MaParoisse/sass/src"`.
